...
/*
 *  Using "Monte ScreenRecorder API" we can record the selenium scripts
 *  Practiced on 05-01-2019
 *  Author : SHAIK PRAVEEN
 */
...
public class MyScreenRecorder extends ScreenRecorder {
	...
	public static void startRecordings(String methodName) throws Exception {
